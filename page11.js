jQuery('.mm-prev-btn').hide();
  ...
  if (results <=30) { // If user chooses the first choice the most, this outcome will be displayed.
    answerbox.innerHTML = "We strongly recommend that you come in for an  assessment";
  }
  else if (results <= 60) { // If user chooses the second choice the most, this outcome will be displayed.
    answerbox.innerHTML = "We recommend that you come in for an assessment.";
  }
  else if (results <= 80) { // If user chooses the second choice the most, this outcome will be displayed.
    answerbox.innerHTML = "We recommend that you come in for an assessment within the next 6 months.";
  }
  if (results == 100) { // If user chooses the third choice the most, this outcome will be displayed.
    answerbox.innerHTML = "It is advised that you retake this assessment in approximately 6 months";
  }
	}
